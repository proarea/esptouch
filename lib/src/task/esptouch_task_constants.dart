class EsptouchConstants {
  ...
  static const int timeoutTotalCodeMillisecond = timeoutGuideCodeMillisecond + timeoutDataCodeMillisecond;
  static const int waitUdpReceivingMillisecond = 15000;
  static const int waitUdpSendingMillisecond = 45000;
  static const int waitUdpTotalMillisecond = waitUdpReceivingMillisecond + waitUdpSendingMillisecond;
  ...
  static const int esptouchResultTotalLen = esptouchResultOneLen + esptouchResultMacLen + esptouchResultIpLen;
